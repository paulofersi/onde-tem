...
const SelectItemText = React.forwardRef<
  React.ComponentRef<typeof ActionsheetItemText>,
  React.ComponentProps<typeof ActionsheetItemText>
>(function SelectItemText(props, ref) {
  return <ActionsheetItemText ref={ref} {...props} />;
});
...
export {
  ...
  SelectItemText, SelectPortal, SelectScrollView, SelectSectionHeaderText, SelectSectionList, SelectTrigger, SelectVirtualizedList
};
